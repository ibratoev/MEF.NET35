...
namespace HouseSpacePlanner
{
    ...
    public partial class SpaceObjectToolBox : UserControl, ISpaceObjectToolbox
    {
        ...
        public PartCreator<SpaceObject, ISpaceObjectMetadata>[] SpaceObjects
        {
            set
            {             
        ...
        public void ItemButtonClicked(object sender, RoutedEventArgs e)
        {
            ...
            var lifetimeContext = helper.Creator.CreatePart();

            lifetimeContext.ExportedValue.RemoveFromPlanningSurfaceRequested += delegate
            {
                SurfaceItems.Remove(lifetimeContext.ExportedValue);
                lifetimeContext.Dispose();
            };

            SurfaceItems.Add(lifetimeContext.ExportedValue);
        }
    }
    ...
    [ExportSpaceObjectToolbox(ToolboxType.House)]
