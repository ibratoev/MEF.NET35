...
namespace HouseSpacePlanner
{
    ...
    {
        public ExportFactory<SpaceObject, ISpaceObjectMetadata> Creator { get; private set; }
        ...
        public SpaceObjectBindingHelper(ExportFactory<SpaceObject, ISpaceObjectMetadata> creator)
        {
            Creator = creator;
            SpaceObject = Creator.CreateExport().Value;
        }
    }
}
