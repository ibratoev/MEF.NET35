...
namespace System
{
	...
	public struct Tuple2<TItem1, TItem2>
	{
		public Tuple2(TItem1 item1, TItem2 item2)
		{
			this = new Tuple2<TItem1, TItem2>();
			this.Item1 = item1;
			this.Item2 = item2;
		}
		...
		{
			if (obj is Tuple2<TItem1, TItem2>)
			{
				Tuple2<TItem1, TItem2> that = (Tuple2<TItem1, TItem2>)obj;
		...
		public static bool operator ==(Tuple2<TItem1, TItem2> left, Tuple2<TItem1, TItem2> right)
		{
